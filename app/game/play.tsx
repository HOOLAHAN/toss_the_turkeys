...
const s = StyleSheet.create({
  ...
  counters: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,.88)', borderRadius: 20, paddingVertical: 7, borderWidth: 1.5, borderColor: C.line, shadowColor: C.brown, shadowOpacity: .07, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } }, counterHalf: { flex: 1, alignItems: 'center' }, counterLabel: { fontFamily: 'Nunito_800ExtraBold', fontSize: 9, letterSpacing: 1.2, color: C.muted }, counter: { fontFamily: 'Baloo2_800ExtraBold', fontSize: 34, lineHeight: 37, color: C.brown }, risk: { color: C.red }, divider: { height: 40, width: 1, backgroundColor: C.line },
