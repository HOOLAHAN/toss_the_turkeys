...
const s=StyleSheet.create({screen:{gap:4,paddingBottom:6},content:{paddingBottom:82},hero:{minHeight:116,borderRadius:22,backgroundColor:C.brown,paddingLeft:18,paddingVertical:14,flexDirection:'row',alignItems:'center',overflow:'hidden'},heroWords:{flex:1},heroEyebrow:{fontFamily:'Nunito_800ExtraBold',fontSize:8,letterSpacing:1.6,color:C.gold},heroTitle:{fontFamily:'Baloo2_800ExtraBold',fontSize:21,lineHeight:24,color:C.white,maxWidth:245,marginTop:4},heroCopy:{fontFamily:'Nunito_700Bold',fontSize:9,lineHeight:12,color:'#F6D9C7',maxWidth:225,marginTop:3},sectionTitle:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:14},label:{fontFamily:'Nunito_800ExtraBold',fontSize:10,letterSpacing:1.6,color:C.muted,marginTop:14,marginBottom:7},step:{flexDirection:'row',alignItems:'center',gap:8},stepBtn:{width:31,height:31,borderRadius:10,backgroundColor:C.brown,alignItems:'center',justifyContent:'center'},count:{fontFamily:'Baloo2_800ExtraBold',fontSize:25,lineHeight:31,paddingTop:2,color:C.ink,minWidth:26,textAlign:'center'},tip:{fontFamily:'Nunito_700Bold',fontSize:9,color:C.muted,marginBottom:7},playerCard:{minHeight:78,flexDirection:'row',alignItems:'center',gap:11,marginBottom:7,padding:7,borderRadius:18,backgroundColor:'rgba(255,255,255,.88)',borderWidth:1.5,borderColor:C.line},avatar:{width:66,height:64,borderRadius:17,alignItems:'center',justifyContent:'center',overflow:'hidden'},swap:{position:'absolute',right:3,bottom:3,width:18,height:18,borderRadius:9,backgroundColor:C.brown,alignItems:'center',justifyContent:'center'},swapText:{fontFamily:'Nunito_800ExtraBold',fontSize:11,color:C.white},playerCopy:{flex:1},playerLabel:{fontFamily:'Nunito_800ExtraBold',fontSize:7.5,letterSpacing:.7,color:C.muted,marginBottom:3},input:{height:39,borderWidth:1.5,borderColor:C.line,borderRadius:11,backgroundColor:C.white,paddingHorizontal:11,fontFamily:'Nunito_700Bold',fontSize:15,color:C.ink},targets:{flexDirection:'row',gap:6},pill:{flex:1,height:52,borderRadius:14,borderWidth:1.5,borderColor:C.line,alignItems:'center',justifyContent:'center',backgroundColor:C.white},selected:{backgroundColor:C.brown,borderColor:C.brown},pillNumber:{fontFamily:'Baloo2_800ExtraBold',fontSize:19,lineHeight:26,paddingTop:3,color:C.brown},pointsLabel:{fontFamily:'Nunito_800ExtraBold',fontSize:6.5,lineHeight:9,letterSpacing:.7,color:C.muted},selectedText:{color:C.white},custom:{height:42,borderRadius:13,borderWidth:1.5,borderColor:C.line,backgroundColor:C.white,textAlign:'center',fontFamily:'Nunito_700Bold',fontSize:14,marginTop:7,marginBottom:10,color:C.ink}});
