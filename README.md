...
- `assets/sounds/` contains CC0 interface cues by Kenney and six CC0 turkey gobbles recorded by JarredGibb on Freesound. A different gobble is selected for each toss without immediately repeating the previous call.
